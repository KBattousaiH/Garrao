...
title('A2 Etopo Garrao')
cmocean('deep')
set(get(cb3,'title'),'string','[m]');
saveas(f1,'A2_Etopo_Garrao','png');
%
f2=figure();
m_proj('equidistant','lon',[min(min(Xlim)) max(max(Xlim))],'lat',[min(min(Ylim)) max(max(Ylim))]);
...
caxis([-300 300])
cmocean('balance')
title('A2 Etopo-GRD Garrao')
saveas(f4,'A2_Etopo_-_GRDGarrao','png');
%
f5=figure();
m_proj('equidistant','lon',[min(min(Xlim)) max(max(Xlim))],'lat',[min(min(Ylim)) max(max(Ylim))]);
...
caxis([-300 300])
cmocean('balance')
title('A2 Etopo-GRD CROCO')
saveas(f5,'A2_Etopo_-_GRDCROCO','png');
%
f6=figure();
m_proj('equidistant','lon',[min(min(Xlim)) max(max(Xlim))],'lat',[min(min(Ylim)) max(max(Ylim))]);
...
caxis([-50 50])
cmocean('balance')
title('A2 GRD Garrao-GRD CROCO')
saveas(f6,'A2_GRDGarrao_-_GRDCROCO','png');
%
